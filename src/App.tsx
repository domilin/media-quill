...
function App() {
      ...
      modules: {
        ...
        clipboard: {
          imageUpload: async (url: string): Promise<string> => {
            ...
            const uploadUrl: string = await new Promise(function(resolve) {
              setTimeout(function() {
                resolve("https://hellorfimg.zcool.cn/preview260/700154173.jpg");
              }, 2000);
            });
        ...
        mediaUploader: {
          imageUpload: async (file: File): Promise<string> => {
            ...
            const uploadUrl: string = await new Promise(function(resolve) {
              setTimeout(function() {
                resolve("https://hellorfimg.zcool.cn/preview260/689865370.jpg");
              }, 2000);
            });
  ...
  useEffect(() => {
    ...
    editor.clipboard.dangerouslyPasteHTML(exampleHtml, "user");
  ...
  return (
    <div className="App">
      ...
      <div dangerouslySetInnerHTML={{  __html: exampleHtml }} ></div>
